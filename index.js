...
const fundingInfo = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. ${numUnfunded === 1 ? '1 game remains' : numUnfunded > 1 ? `${numUnfunded} games remain` : 'All games have been'} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const fundingInfoElement = document.createElement('p');
fundingInfoElement.textContent = fundingInfo;
